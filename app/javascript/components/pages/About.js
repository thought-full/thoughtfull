        ...
        <CardDeck style={{ margin: "0 12%" }}>
          ...
          <Card className="card border-light mb-3" style={ card }>
            ...
            <Card.Body>
              ...
              <Card.Text>
              Full stack web developer, backed by 4+ years of experience as a Financial Analyst. I am passionate about collaborating with others, and using my analytical background to solve problems and develop creative solutions. 
            </Card.Text>
