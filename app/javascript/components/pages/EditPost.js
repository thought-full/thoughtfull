...
class EditPost extends React.Component {
  ...
  localSubmit = e => {
    ...
    editPost(postAttrs.id, postAttrs).then(() => {
  ...
  getPost() {
    ...
    showPost(this.props.match.params.id).then(response => {
